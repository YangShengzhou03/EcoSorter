...
import 'package:ecosorter/screens/point_records_screen.dart';
...
import 'package:ecosorter/screens/nearby_trashcans_screen.dart';
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          switch (settings.name) {
            ...
            case '/point-records':
              return MaterialPageRoute(builder: (context) => const PointRecordsScreen());
            case '/points':
            ...
            case '/map':
              return MaterialPageRoute(builder: (context) => const NearbyTrashcansScreen());
          }
          return null;
        },
      ),
