...
const routes = [
  ...
  { 
    ...
    component: () => import("./views/index/UserForgotPassword.vue") 
  },
  {
    path: "/index",
    children: [
...
const PUBLIC_PATHS = ["/", "/login", "/register", "/forgot-password", "/index/recyclable", "/index/hazardous", "/index/kitchen", "/index/other", "/index/about", "/index/contact", "/index/privacy-policy", "/index/user-agreement", "/resident/product/:id", "/collector/product/:id"];
