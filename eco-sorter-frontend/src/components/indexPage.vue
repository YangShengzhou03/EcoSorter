        ...
        <header class="header" :class="{ 'header-scrolled': isScrolled }">
            <div class="header-content">
                <div class="header-left">
                    <span class="logo">ECO-Sorter</span>
                    <nav class="nav-links">
            ...
            <div class="footer-content">
                <div class="footer-nav">
                    ...
                    <div class="footer-nav-column">
                        ...
                        <ul class="footer-nav-list">
                            <li><a href="#" @click.prevent="router.push('/index/privacy-policy')">隐私政策</a></li>
                            <li><a href="#" @click.prevent="router.push('/index/user-agreement')">用户协议</a></li>
                        </ul>
                    </div>
                </div>
                <div class="footer-bottom">
                    <div class="footer-info">
                        <span class="footer-logo">ECO-Sorter</span>
                        <div class="footer-copyright">
                            <p>&copy; {{ currentYear }} ECO-Sorter 智能垃圾分类系统 版权所有</p>
                            <p>
                                江西易控环保科技有限公司
                                <span class="divider">|</span>
                                <a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener noreferrer">赣ICP备2025075576号</a>
                                <span class="divider">|</span>
                                <a href="https://beian.mps.gov.cn/#/query/webSearch?code=36010802001254" target="_blank" rel="noopener noreferrer">赣公网安备36010802001254号</a>
                            </p>
                        </div>
                    </div>
                </div>
