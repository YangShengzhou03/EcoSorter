<template>
  <el-watermark :content="watermarkContent" class="collector-watermark">
...
import { DEFAULT_AVATAR, createBreadcrumbUpdater } from '@/utils/constants'
...
const watermarkContent = userInfo.value.email || 'collector@ecosorter.com'
