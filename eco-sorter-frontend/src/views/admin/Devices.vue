      ...
      <el-form :model="deviceForm" :rules="rules" ref="formRef" label-width="100px">
        ...
        <el-form-item label="经纬度" prop="coordinates">
          <div class="coordinates-row">
            <el-input-number v-model="deviceForm.latitude" :precision="8" :min="-90" :max="90" placeholder="纬度" controls-position="right" class="coordinate-input" />
            <span class="coordinate-separator">/</span>
            <el-input-number v-model="deviceForm.longitude" :precision="8" :min="-180" :max="180" placeholder="经度" controls-position="right" class="coordinate-input" />
          </div>
        </el-form-item>
