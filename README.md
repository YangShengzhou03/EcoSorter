...
### 🤝 核心贡献者  
- **项目负责人**: 架构设计、技术选型、进度管理  
  - 负责端: 全端协调  
  - 联系方式: 3555844679@qq.com

- **AI算法工程师**: 模型训练、边缘推理优化、数据标注  
  - 负责端: 安卓APP、垃圾桶Web端  
  - 联系方式: yangsz03@foxmail.com

- **全栈开发**: 前后端开发、API设计、数据库优化  
  - 负责端: 网页前端、后端API  
  - 联系方式: yangsz03@foxmail.com

- **移动端开发**: Android应用开发、跨端技术  
  - 负责端: 安卓APP端  
  - 联系方式: yangsz03@foxmail.com
